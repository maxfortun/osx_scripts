...
on run
	...
	do shell script haScriptsPath & "/haAPI.sh light turn_on home_living_track brightness:35"
	do shell script haScriptsPath & "/haAPI.sh light turn_off home_living_floor"
	do shell script haScriptsPath & "/haAPI.sh light turn_off home_kitchen_track"
end run
